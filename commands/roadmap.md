...
5. **Hesapla** — `python3 ${CLAUDE_PLUGIN_ROOT}/skills/roadmap-architect/scripts/plan_capacity.py plan.json`
6. **Görseller** — `python3 ${CLAUDE_PLUGIN_ROOT}/skills/roadmap-architect/scripts/render_visuals.py plan.json --out docs/assets --audience customer`
